...
P_DYNAMIC_ISLAND_DEFAULT_WIDTH=88
...
P_DYNAMIC_ISLAND_MONITOR_HORIZONTAL_RESOLUTION=1470

# Animation Settings
P_DYNAMIC_ISLAND_SQUISH_AMOUNT=4

#
## App Switch Island config
#
P_DYNAMIC_ISLAND_APPSWITCH_MAX_EXPAND_WIDTH=126 # Max size per character of app name
P_DYNAMIC_ISLAND_APPSWITCH_EXPAND_HEIGHT=46
...
#
P_DYNAMIC_ISLAND_VOLUME_MAX_EXPAND_WIDTH=126 # Max size when expanded
P_DYNAMIC_ISLAND_VOLUME_EXPAND_HEIGHT=66
...
#
P_DYNAMIC_ISLAND_BRIGHTNESS_MAX_EXPAND_WIDTH=126 # Max size when expanded
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_HEIGHT=66
...
P_DYNAMIC_ISLAND_MUSIC_INFO_MAX_EXPAND_WIDTH=220 # Max size when expanded#
P_DYNAMIC_ISLAND_MUSIC_INFO_EXPAND_HEIGHT=100
P_DYNAMIC_ISLAND_MUSIC_INFO_CORNER_RAD=12 # Corner Radius

# Music Idle Info
P_DYNAMIC_ISLAND_MUSIC_IDLE_EXPAND_WIDTH=170
P_DYNAMIC_ISLAND_MUSIC_IDLE_EXPAND_HEIGT=100

# Resume Info
P_DYNAMIC_ISLAND_MUSIC_RESUME_MAX_EXPAND_WIDTH=220
P_DYNAMIC_ISLAND_MUSIC_RESUME_EXPAND_HEIGHT=100
P_DYNAMIC_ISLAND_MUSIC_RESUME_CORNER_RAD=12 # Corner Radius

#
## WIFI Island config
#
P_DYNAMIC_ISLAND_WIFI_MAX_EXPAND_WIDTH=126 # Max size when expanded
P_DYNAMIC_ISLAND_WIFI_EXPAND_HEIGHT=46
...
#
P_DYNAMIC_ISLAND_BATTERY_MAX_EXPAND_WIDTH=164 # Max size when expanded
P_DYNAMIC_ISLAND_BATTERY_EXPAND_HEIGHT=46
