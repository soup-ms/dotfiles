...
P_DYNAMIC_ISLAND_APPSWITCH_CORNER_RAD=10 # Corner Radius
P_DYNAMIC_ISLAND_APPSWITCH_ICON_SIZE=1

#
## Volume Island config
#
P_DYNAMIC_ISLAND_VOLUME_MAX_EXPAND_WIDTH=100 # Max size when expanded
P_DYNAMIC_ISLAND_VOLUME_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_VOLUME_CORNER_RAD=10 # Corner Radius
...
#
P_DYNAMIC_ISLAND_BRIGHTNESS_MAX_EXPAND_WIDTH=100 # Max size when expanded
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_BRIGHTNESS_CORNER_RAD=10 # Corner Radius
...
P_DYNAMIC_ISLAND_MUSIC_INFO_CORNER_RAD=10 # Corner Radius

# Music Idle Info
P_DYNAMIC_ISLAND_MUSIC_IDLE_EXPAND_WIDTH=150
P_DYNAMIC_ISLAND_MUSIC_IDLE_EXPAND_HEIGHT=100

# Resume Info
P_DYNAMIC_ISLAND_MUSIC_RESUME_MAX_EXPAND_WIDTH=150
P_DYNAMIC_ISLAND_MUSIC_RESUME_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_MUSIC_RESUME_CORNER_RAD=10 # Corner Radius

#
## WIFI Island config
#
P_DYNAMIC_ISLAND_WIFI_MAX_EXPAND_WIDTH=100 # Max size when expanded
P_DYNAMIC_ISLAND_WIFI_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_WIFI_CORNER_RAD=10 # Corner Radius
...
#
P_DYNAMIC_ISLAND_BATTERY_MAX_EXPAND_WIDTH=100 # Max size when expanded
P_DYNAMIC_ISLAND_BATTERY_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_BATTERY_CORNER_RAD=10 # Corner Radius
...
#
P_DYNAMIC_ISLAND_NOTIFICATION_MAX_EXPAND_WIDTH=150 # Max size when expanded
P_DYNAMIC_ISLAND_NOTIFICATION_EXPAND_HEIGHT=50
P_DYNAMIC_ISLAND_NOTIFICATION_CORNER_RAD=10        # Corner Radius
